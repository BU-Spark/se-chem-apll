...
import MarkdownField from '@/app/components/QuestionBank/MarkdownField';
    ...
    <div className={styles.questionCard}>
      ...
      {expanded && (
        <div className={styles.questionBody} id={panelId}>
          <div className={styles.questionBodyToolbar}>
            {view === 'edit' && (
            ...
            <div className={styles.questionViewToggle} role="group" aria-label={`${itemLabel} view`}>
          ...
          {view === 'preview' ? (
            ...
            <>
              <MarkdownField
                label={isNote ? 'Note' : 'Question prompt'}
                required
                value={q.prompt}
                ...
                <div className={styles.choiceList}>
                  ...
                  {q.choices.map((choice, ci) => (
                    <div key={ci} className={styles.choiceRow}>
                      ...
                      />
                      <div className={styles.choiceMarkdownField}>
                        <MarkdownField
                          label={`Choice ${ci + 1}`}
                          compact
                          value={choice}
                          onChange={(value) => onUpdateChoice(ci, value)}
